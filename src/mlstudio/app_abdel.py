...
Process:
    ...
    - Create useful charts, including an Actual Scores vs Predicted Scores chart.
...
def plot_actual_vs_predicted(
    ...
    """Visualize actual scores compared with model predictions."""
    ...
    result_plt: Axes = sns.scatterplot(
        data=results_df,
        x="actual_score",
        y="predicted_score",
        ax=ax,
    ...
    min_score = min(
        results_df["actual_score"].min(),
        results_df["predicted_score"].min(),
    )
    max_score = max(
        results_df["actual_score"].max(),
        results_df["predicted_score"].max(),
    )
    ...
    result_plt.set_title("Actual Scores vs Predicted Scores")
    result_plt.set_xlabel("Actual Score")
    result_plt.set_ylabel("Predicted Score")
